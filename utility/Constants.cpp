...
const ConstantString * const polarity_up_ptr =  &audio_controller::constants::polarity_positive;
const ConstantString * const polarity_down_ptr =  &audio_controller::constants::polarity_negative;
